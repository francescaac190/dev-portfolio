...
export const Projects = () => {
    return (
        <section id="projects" className="py-32 realtive overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <p className="text-muted-foreground animate-fade-in animation-delay-200">
                    A selection of my work, from mobile & web applications to data analytics dashboards that solve real-world problems.
                </p>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    {projects.map((project, idx) => (
                        <div
                            ...
                            <div className="reltive overflow-hidden aspect-video">
                                <img 
                                    src={project.image}
                                    alt={project.title}
